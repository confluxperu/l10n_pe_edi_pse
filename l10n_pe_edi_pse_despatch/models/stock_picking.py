...
class StockPicking(models.Model):
	...
	def _prepare_despatch(self):
		...
		if picking.location_dest_id.usage=='supplier' and picking.partner_id:
			despatch['l10n_pe_edi_seller_supplier_id'] = picking.partner_id.id
		if picking.picking_type_id.code=='incoming':
			despatch['l10n_pe_edi_shipment_reason'] = '02'
		elif picking.picking_type_id.code=='internal':
			despatch['l10n_pe_edi_shipment_reason'] = '04'
		if picking.note:
